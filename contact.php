...
if($_POST)
{
    $to_Email   	= "tonydisera@berkeley.edu"; //Replace with recipient email address
    ...
    */
    ...
    if(!$sentMail)
    {
        ...
        $output = json_encode(array('type'=>'message', 'text' => 'Hi '.$user_Name .'. Thank you for contacting me.'));
        die($output);
    }
}
?>